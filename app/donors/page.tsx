...
export const metadata = {
  ...
  description:
    "Help us educate and care for vulnerable children in Nzoia, Bungoma. Your donation changes lives.",
...
export default function DonorsPage() {
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <Breadcrumb items={[{ name: "Support Our Children", path: "/donors" }]} />
      <TopBar />
      <Header />
      <Navbar />
        ...
        <div className="relative mx-auto max-w-[1400px] px-4 lg:px-6">
          <div className="max-w-3xl">
            ...
            <p className="mb-4 max-w-2xl text-lg leading-9 text-white/80">
              In 2013, Fountain of Hope Academy opened its doors in Nzoia,
              Bungoma — not just as a school, but as a lifeline. Founded with a
            ...
            <div className="rounded-3xl border border-slate-200 bg-[#fffaf2] p-8">
              ...
              <ol className="space-y-4">
                {[
                  ...
                  "Ship to our address in Nzoia, Bungoma or arrange with a local contact",
