...
const FAKE = [
  ...
  { members: 85, weekly: 95, founded: "2013", status: "active" as const, phone: "+254 721 683 397" },
];
    ...
    <div>
      ...
      <div className="mx-auto max-w-[1400px] space-y-6 px-5 py-7 md:px-8 md:py-10">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard icon={MapPin} accent="navy" label="Total Branches" value={String(branches.length)} sub={`HQ + ${branches.length - 1} daughter churches`} />
