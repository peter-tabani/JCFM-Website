...
export const metadata = {
  ...
  description: "Primary School (Grade 1–6) at Fountain of Hope Academy, Nzoia, Bungoma. CBC curriculum. Download fee structure.",
...
export default function PrimaryPage() {
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <Breadcrumb items={[{ name: "Primary School", path: "/primary" }]} />
      {/* ── Hero ── */}
      <section className="bg-[#0f172a] px-4 py-14 text-white md:py-20 lg:px-6">
        <div className="mx-auto max-w-[1400px]">
          ...
          <p className="mb-8 max-w-xl text-base leading-8 text-white/60">
            A CBC-based programme at Fountain of Hope Academy, Nzoia, Bungoma —
        ...
        <div className="mx-auto max-w-[1400px]">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { label: "Location", value: "Nzoia, Bungoma County" },
