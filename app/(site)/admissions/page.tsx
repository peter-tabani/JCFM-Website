...
export const metadata = {
  ...
  description:
    "Apply for admission at JCFM School – Nzoia, Bungoma. Open for ECDE, Primary, and Junior Secondary learners.",
...
export default function AdmissionsPage() {
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <Breadcrumb items={[{ name: "Admissions", path: "/admissions" }]} />
      ...
      <section className="relative overflow-hidden bg-[#1e3a5f] py-14 text-white md:py-24">
        ...
        <div className="relative mx-auto max-w-[1400px] px-4 lg:px-6">
          ...
          <p className="mb-6 max-w-xl text-base leading-8 text-white/80 md:mb-8 md:text-lg">
            Open for learners from age 3 through Grade 9 in Nzoia, Bungoma.
