...
export const metadata = {
  ...
  description: "Junior Secondary School (Grade 7–9) at Fountain of Hope Academy, Nzoia, Bungoma. CBC curriculum. KJSEA. Download fee structure.",
...
export default function SecondaryPage() {
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <Breadcrumb items={[{ name: "Junior Secondary", path: "/secondary" }]} />
      {/* ── Hero ── */}
            ...
            <div>
              ...
              <div className="mt-8 rounded-2xl border border-slate-200 bg-[#fffaf2] p-5">
                <p className="text-sm leading-7 text-slate-600">
                  Visit our office in Nzoia, Bungoma County
                  or email{" "}
