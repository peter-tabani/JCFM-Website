...
// ── Stories & Progress (general updates feed) ─────────────
export type Story = {
  id: string;
  date: string;
  category: CategoryKey;
...
export const stories: Story[] = [
  {
    ...
    date: "22 Apr 2026",
    category: "buildings",
    title: "Walls up to the lintel on Block B",
    body:
      "Two of the four classrooms now stand with finished blockwork. The contractor expects to start on the roof timbers in early May. Thank you for praying us this far.",
    photo: img("wall-build-2", 1200, 700),
    projectId: "proj-classrooms",
  },
  {
    id: "st-002",
    date: "12 Apr 2026",
    category: "children",
    title: "Aaliyah's term-1 report card",
    body:
      "Aaliyah finished Term 1 with 86% overall and the highest mark in her class for English. Her teacher writes: 'A confident, kind child who is a joy to teach.'",
    photo: img("report-card-1", 1200, 700),
    projectId: "spon-aaliyah",
  },
  {
    id: "st-003",
    date: "05 Apr 2026",
    category: "community",
    title: "Water filter stage installed",
    body:
      "The sediment and carbon filter stage of the purification system is now live. We are raising the last KSh 185k for the UV stage which makes the water fully safe to drink.",
    photo: img("water-filter-1", 1200, 700),
  ...
  },
  {
    ...
    date: "28 Mar 2026",
    category: "buildings",
    title: "Kitchen drawings finalised",
    body:
      "We now have a clear plan for the kitchen, stores and a simple dining space. Once funded, we hope to break ground in late May.",
    photo: img("kitchen-plan-1", 1200, 700),
  ...
  },
  {
    ...
    date: "14 Mar 2026",
    category: "buildings",
    title: "Two new pit latrines ready",
    body:
      "The Infrastructure Fund paid for two new pit latrines for the lower classes — long overdue and already in daily use.",
    photo: img("infra-latrine-2", 1200, 700),
  ...
  },
  {
    ...
    date: "06 Mar 2026",
    category: "missions",
    title: "Final 60 study Bibles handed out",
    body:
      "The last 60 Bibles in the 240-Bible drive went out at the joint communion service. The drive is complete, ahead of schedule.",
    photo: img("bible-handout-4", 1200, 700),
    projectId: "proj-bibles",
  },
];
