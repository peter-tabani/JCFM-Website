...
export default function Hero() {
  return (
    <>
      {/* ── Main banner ── */}
      {/* Note: no header/nav here — the (site) layout already renders the
          persistent TopBar/Header/Navbar above every page, this section is
          just the visual banner. */}
      <section className="relative isolate min-h-[85vh] overflow-hidden bg-[#0f172a]">
        <img
          src={demoHeroImage}
        ...
        <div className="relative z-10 mx-auto flex min-h-[85vh] max-w-[1400px] flex-col items-center justify-center px-5 pb-16 text-center sm:px-6">
      ...
      <section className="border-b border-white/10 bg-black">
        <div className="mx-auto max-w-3xl px-6 py-12 text-center sm:py-14">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-[14px] leading-7 text-white sm:text-[15px] sm:leading-8">
            ...
            {" "}{siteData.formerLocation}, now headquartered in{" "}
            {siteData.location} and reaching across Kenya through{" "}
            {siteData.branches.length} growing branches. Since {siteData.founded} we
            have worshipped, served and grown together — expanding the Kingdom
            of God, one community at a time. Wherever you join us, there is a
            place for you here. You are welcome home.
          </p>
        </div>
      </section>
