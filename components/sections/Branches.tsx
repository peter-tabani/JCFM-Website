...
export default function Branches() {
  ...
  return (
    <section id="branches" className="border-b border-white/10 bg-[#080b16]">
      ...
      {/* Header */}
      <div className="border-b border-white/10 bg-[#0b1322]">
        <div className="mx-auto flex max-w-[1400px] flex-col items-center px-5 py-10 text-center md:py-12">
          ...
          <h2 className="mt-4 font-serif text-[22px] font-semibold uppercase leading-tight tracking-[0.06em] text-white md:text-3xl">
