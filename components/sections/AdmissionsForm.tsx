...
const steps = [
  ...
  { num: "2", title: "Get Fee Structure", desc: "Visit our office in Nzoia, Bungoma." },
...
export default function AdmissionsForm() {
  ...
  // Honeypot — see DonorContactForm.tsx for the reasoning.
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm lg:p-10">
          {status === "success" ? (
            ...
            <form onSubmit={submit} className="space-y-8">
              {/* Honeypot — bots fill every field they can find; real users
                  never see this (off-screen, not display:none, excluded
                  from tab order). */}
              <input
                ref={honeypotRef}
                type="text"
