...
export default function DonorContactForm() {
  ...
  // off-screen, not display:none — some bots skip display:none fields but
  // still blindly fill anything they can find in the DOM). If it has a
  // value on submit, silently pretend success instead of telling the bot
  // it got caught.
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm lg:p-10">
      ...
      <form onSubmit={submit} className="space-y-5">
        {/* Honeypot — bots fill every field they can find; real users never
            see this (off-screen, not display:none, excluded from tab order). */}
        <input
          ref={honeypotRef}
          type="text"
          name="_gotcha"
