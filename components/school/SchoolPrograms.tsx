...
// Grade-level pages that exist beyond this overview — not every program
// code has one (Playgroup doesn't), so this is intentionally partial.
            ...
            {s.programs.map((p) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  {PROGRAM_HREF[p.code] && (
                    <Link
                      href={PROGRAM_HREF[p.code]}
                      className="mt-5 flex items-center justify-center gap-2 border-t border-[#d4d0c4] pt-4 text-[11px] font-bold uppercase tracking-[0.22em] text-[#15803d]"
                    >
                      Fees & Details
          ...
          {s.programs.map((p, i) => (
            ...
            >
              ...
              {PROGRAM_HREF[p.code] && (
                <Link
                  href={PROGRAM_HREF[p.code]}
                  className="mt-5 flex items-center gap-2 border-t border-[#d4d0c4] pt-4 text-[11px] font-bold uppercase tracking-[0.22em] text-[#15803d] transition group-hover:text-[#0b2545]"
                >
                  Fees & Details
                  <ArrowRight size={13} strokeWidth={2.5} />
                </Link>
