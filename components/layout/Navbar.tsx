...
import {
  ...
  BookOpen, Heart, MapPin, Home, Church, Radio,
} from "lucide-react";
...
const searchIndex = [
  ...
  { title: "Church Life", desc: "Sunday services, worship & fellowship", href: "/church", icon: <Church size={16} />, tags: ["church", "service", "sunday", "worship", "fellowship", "prayer", "ministries", "youth", "children", "women", "outreach"] },
  ...
  { title: "Hope for Young Women", desc: "Restoring dignity — mentorship, counseling & skills for young women", href: "/hope-for-young-women", icon: <Heart size={16} />, tags: ["hope", "young", "women", "girls", "mentorship", "sarah", "widows", "dignity"] },
  { title: "Sermons", desc: "Sermon highlights & media gallery", href: "/church", icon: <Radio size={16} />, tags: ["sermons", "messages", "preaching", "watch", "listen", "media"] },
  { title: "Stories", desc: "Voices from our communities", href: "/stories", icon: <Heart size={16} />, tags: ["stories", "testimony", "witness", "voices"] },
  { title: "Contact Us", desc: "Talk to the Ministry leadership", href: "/contact", icon: <MapPin size={16} />, tags: ["contact", "location", "address", "mombasa", "miritini", "bungoma", "talk"] },
  { title: "Donate", desc: "Give to JCFM — tithes, offerings, missions & building fund", href: "/donate", icon: <Heart size={16} />, tags: ["donate", "give", "giving", "tithe", "offering", "paypal", "support"] },
  { title: "Email JCFM", desc: siteData.email, href: `mailto:${siteData.email}`, icon: <Mail size={16} />, tags: ["email", "mail", "write", "contact", "info"] },
  { title: "Headquarters", desc: "Miritini, Mombasa, Kenya", href: "/contact", icon: <MapPin size={16} />, tags: ["location", "where", "address", "mombasa", "miritini", "bungoma", "hq", "headquarters"] },
...
const QUICK_SEARCHES = ["Church", "School", "Give", "Sermons", "Contact", "Branches", "Admissions"];
      ...
      <div className={`fixed right-0 top-0 z-50 flex h-full w-[320px] max-w-[90vw] flex-col bg-white shadow-2xl transition-transform duration-300 lg:hidden ${drawerOpen ? "translate-x-0" : "translate-x-full"}`}>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="border-b border-slate-200">
            <a href={`mailto:${siteData.email}`} onClick={() => setDrawerOpen(false)} className="flex items-center justify-center gap-2 bg-[#4c1d95] py-4 text-white">
          ...
          <div>
            ...
            {[
              { label: "Admin Sign In", href: "/login", newTab: true },
