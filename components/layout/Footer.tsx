...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[#050713] py-16 text-white">
      <div className="mx-auto grid max-w-[1400px] gap-10 px-4 lg:grid-cols-4 lg:px-6">
        ...
        <div>
          ...
          <p className="mt-4 leading-8 text-white/65">
            ...
            headquartered in {siteData.location}, with branches across Kenya.
          </p>
        ...
        <div>
          ...
          <div className="space-y-3 text-white/65">
            <p><Link href="/church" className="transition hover:text-[#c4b5fd]">Sunday Worship Services</Link></p>
            <p><Link href="/hope-for-young-women" className="transition hover:text-[#c4b5fd]">Hope for Young Women</Link></p>
            <p><Link href="/church" className="transition hover:text-[#c4b5fd]">Bible Study & Prayer</Link></p>
            <p><Link href="/mission-trips" className="transition hover:text-[#c4b5fd]">Outreach & Evangelism</Link></p>
            <p><Link href="/branches" className="transition hover:text-[#c4b5fd]">Branch Network across Kenya</Link></p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-3 text-white/65">
            <a
              ...
              className="block transition hover:text-[#c4b5fd]"
            >
              Headquarters · {siteData.location}, Kenya
            </a>
            <a href={`mailto:${siteData.email}`} className="block transition hover:text-[#86efac]">
              {siteData.email}
            </a>
            <Link href="/school" className="block transition hover:text-[#c4b5fd]">
              Our Academy School
            </Link>
