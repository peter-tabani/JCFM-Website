  ...
  return (
    <aside className="flex h-full w-full flex-col overflow-y-auto border-r border-slate-200 bg-white text-slate-900 lg:w-[240px]">
      ...
      <nav className="flex-1 py-2">
        <Section title="Home" items={PRIMARY} isActive={isActive} onClose={onClose} />
        <Section title="Ministry" items={MINISTRY} isActive={isActive} onClose={onClose} />
        <Section title="Finance" items={FINANCE} isActive={isActive} onClose={onClose} />
        <Section title="Education" items={SCHOOL} isActive={isActive} onClose={onClose} />
        <Section title="System" items={SYSTEM} isActive={isActive} onClose={onClose} />
      </nav>
